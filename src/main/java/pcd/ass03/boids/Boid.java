...
public class Boid {
    ...
    public void calculateVelocity(BoidsModel model) {
        ...
        this.separation = this.calculateSeparation(nearbyBoids, model);
        this.alignment = this.calculateAlignment(nearbyBoids, model);
        this.cohesion = this.calculateCohesion(nearbyBoids, model);
    }
